...
import { Send, CheckCircle2, Shield, Banknote, FileCheck, Clock, ShieldCheck } from "lucide-react";
...
function SellPage() {
  ...
  const handlePreSubmit = (e: React.FormEvent) => {
    ...
    if (!form.name.trim() || !form.phone.trim() || !form.make.trim() || !form.model.trim()) {
      setError("Please fill in your contact details and car information.");
      return;
    }
        ...
        <main className="mx-auto max-w-6xl px-6 py-20">
          ...
          {done ? (
            ...
            <RevealSection delay={200}>
              <form
                className="mt-16 rounded-2xl border border-border/20 bg-card/10 p-8 md:p-12"
              ...
              >
                ...
                <div className="mt-8">
                  ...
                  >
                    ...
                    {sending ? "Sending…" : "Verify OTP & Request Quote"}
                  </button>
                </div>
              </form>
            </RevealSection>
